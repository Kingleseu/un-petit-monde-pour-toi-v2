...
function fromSettings(row) {
  ...
  return {
    ...
    templateId: row.template_id || 'romance',
    transitionType: row.transition_type || 'fade',
  };
}
...
function toSettings(content) {
  return {
    ...
    template_id: content.templateId || 'romance',
    transition_type: content.transitionType || 'fade',
  };
}
